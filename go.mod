...
require (
	github.com/hashicorp-dev-advocates/terraform-provider-waypoint v0.0.3
	github.com/hashicorp-dev-advocates/waypoint-client v0.0.0-20220614092443-25f9a4b17102
